...
function dashboard(theme: 'light' | 'dark', zoom = true): string {
  ...
  return html
    ...
    .replace('<div id="stats" class="stats" aria-live="polite"></div>', '<div id="stats" class="stats" aria-live="polite"><div class="stat"><strong>12</strong><span>Sách trong kết quả</span></div><div class="stat"><strong>4</strong><span>Định dạng</span></div><div class="stat"><strong>3</strong><span>Chưa có ngôn ngữ</span></div><div class="stat"><strong>2</strong><span>Chưa có nguồn bìa</span></div></div>')
